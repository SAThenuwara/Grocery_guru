...
class FishCategoryActivity : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    // Define product names, weights, and image resources
    private val productNames = arrayOf("Tilapiya", "Salmon", "Mackerel", "Sardine", "Cod", "Haddock")
    private val productWeights = arrayOf("500g", "500g", "500g", "1kg", "1kg", "500g")
